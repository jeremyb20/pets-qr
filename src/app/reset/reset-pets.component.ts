...
export class ResetPetsComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private _petService: PetService,private _notificationSvc: NotificationService, private route: ActivatedRoute , private router: Router) {
    ...
    onResetPasswordSubmit(){
      ...
      this._petService.resetPassword(reset).subscribe(data => {
        if(data.success) {
          this.loading = false;
          Swal.fire({
