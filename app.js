...
app.use(function (req, res, next) {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Origin, Accept, Accept-Version, Content-MD5, Content-Type, Date, X-Api-Version, X-Response-Time, X-PINGOTHER, X-CSRF-Token,Authorization');
